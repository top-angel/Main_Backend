...
from commands.dataunions.wedatanation import AddUserAmazonDataFromZipFile
...
if __name__ == "__main__":
    ...
    try:
        c = AddUserAmazonDataFromZipFile(public_address, file)
        result = c.execute()
        if not c.successful:
        ...
        logging.exception("Exception occurred", exc_info=e)
