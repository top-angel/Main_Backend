...
class GetUserSwipeCommand(BaseCommand):
    def __init__(self):
        super(GetUserSwipeCommand, self).__init__()
    ...
    def execute(self):
        ...
        result = taxonomy_dao.get_user_swipe_stats(public_address, start_date, end_date)
